...
# Start KDA CP affine-state and convolution-tail gathers asynchronously so
# independent cache/state preparation can overlap HCCL communication.
export SGLANG_KDA_CP_ASYNC_GATHER="${SGLANG_KDA_CP_ASYNC_GATHER:-1}"
export SGLANG_KIMI_K3_LOG_PCP_EVERY_BATCH="${SGLANG_KIMI_K3_LOG_PCP_EVERY_BATCH:-0}"
...
MAX_TOTAL_TOKENS="${MAX_TOTAL_TOKENS:-327680}"
