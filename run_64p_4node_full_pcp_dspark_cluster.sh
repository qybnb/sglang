...
COMMON_ENV=(
    ...
    "SGLANG_DEEPEP_NUM_MAX_DISPATCH_TOKENS_PER_RANK=${SGLANG_DEEPEP_NUM_MAX_DISPATCH_TOKENS_PER_RANK:-128}"
    ...
    "SGLANG_KDA_CP_ASYNC_GATHER=${SGLANG_KDA_CP_ASYNC_GATHER:-1}"
    "SGLANG_KIMI_K3_LOG_PCP_EVERY_BATCH=${SGLANG_KIMI_K3_LOG_PCP_EVERY_BATCH:-0}"
