...
#
# Decode uses the minimal validation profile: DP-attention, DeepEP, dSparK and
# decode graph are disabled. TP48 satisfies the Kimi-K3 attention-head and MLP
# divisibility constraints, but final memory capacity still depends on the
# checkpoint, CANN runtime and NPU model.
#
# Examples:
...
export DECODE_NNODES=3
export DEPLOYMENT_NAME="seven-node 4P3D"
